  ...
  return (
    <main className="dashboard-shell-root flex h-full min-h-0 w-full min-w-0 overflow-hidden bg-[#070907]/95 text-slate-100">
      ...
      <section className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
        <header className="dashboard-shell-header flex min-h-14 shrink-0 items-center justify-between gap-3 border-b border-white/10 bg-[#090c0a]/92 px-3 py-2 backdrop-blur sm:px-6 min-[1180px]:min-h-16 min-[1180px]:px-7">
