    ...
    <section className="app-row p-4">
      ...
      <div className="mt-4 grid gap-3">
        {DOSHAB_THEMES.map((theme) => {
          ...
          return (
            <article
              className={`theme-choice-card app-card p-3 transition ${
                ...
                <div className="min-w-0">
                  ...
                  <div className="mt-3 flex flex-wrap gap-1.5">
                    {theme.previewDetails.map((detail) => (
                      <span className="theme-preview-chip" key={detail}>
                        {detail}
                      </span>
                    ))}
                  </div>
                  {theme.themeIcons ? (
                    <div className="theme-icon-strip mt-3 flex flex-wrap gap-1.5">
                      {theme.themeIcons.map((icon) => (
                        <span className="theme-icon-token" key={icon.id} title={icon.label}>
                          <ThemeIcon className="h-3.5 w-3.5" id={icon.id} />
  ...
  return (
    ...
    >
      ...
      <div className="amir-preview-file">
        ...
        <h5>Agent Amir</h5>
        <div className="amir-preview-grid">
          <span>
          ...
          <span>
            ...
            Stealth Mode: <strong>Funny</strong>
          </span>
          <span>
            <ThemeIcon className="h-3.5 w-3.5" id="id-badge" />
            Agent Status: <em>Unpredictable</em>
          </span>
          <span>
  ...
  return (
    ...
    >
      ...
      <div className="nima-preview-panel">
        ...
        <div className="nima-preview-status-list">
          <span>
            <ThemeIcon className="h-3.5 w-3.5" id="trust-level" />
            Trust Level: <strong className="nima-preview-danger">Low</strong>
          </span>
          <span>
  ...
  return (
    ...
    >
      ...
      <div className="threez-preview-panel">
        ...
        <div className="threez-preview-status-list">
          <span>
            <ThemeIcon className="h-3.5 w-3.5" id="hero-shield" />
            Hero Fit: <strong>Active</strong>
          </span>
          <span>
            <ThemeIcon className="h-3.5 w-3.5" id="sneaker" />
            Sneaker Status: <strong>Clean</strong>
          </span>
          <span>
            <ThemeIcon className="h-3.5 w-3.5" id="mind-map-nodes" />
            Mind Map: <em>Confused</em>
          </span>
          <span>
      ...
      <div className="hamp-preview-panel">
        ...
        <div className="hamp-preview-status-list">
          <span>
            ...
            Root System: <strong>Online</strong>
          </span>
          <span>
            <ThemeIcon className="h-3.5 w-3.5" id="forge-build" />
            Forge Status: <strong>Active</strong>
          </span>
          <span>
